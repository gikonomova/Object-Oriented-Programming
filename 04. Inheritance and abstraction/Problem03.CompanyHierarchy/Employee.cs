...
namespace Problem03.CompanyHierarchy
{
    public abstract class Employee : Person, IEmployee
    {
        ...
        public Employee(string firstName, string lastName, int id, decimal salary, Departments departments)
        ...
        public override string ToString()
        {
            ...
            sb.AppendLine(string.Format("Salary: {0}", this.Salary));
            sb.AppendLine(string.Format("Department: {0}", this.Departments));
